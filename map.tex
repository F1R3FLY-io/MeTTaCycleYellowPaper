...
case use cases may span multiple networks, travel being a prime
example. One can easily imagine the airlines settle on one network,
while the hospitality providers settle on another. The user doesn't
actually care. They just want to book a trip including airfare and
hospitality.
...
opens up a new world of possibilities for how to bring features to
other networks.
